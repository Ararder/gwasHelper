test_that("filepath_manager returns the correct filepath structure", {
  ...
  expected_structure <- list(
    ...
    pldsc = fs::path(test_path("data/gwas_repo/bipolar_disorder/bipolar_disorder/analysis/ldsc/pldsc")),
    pldsc_siletti = fs::path(test_path("data/gwas_repo/bipolar_disorder/bipolar_disorder/analysis/ldsc/pldsc/siletti")),
    pldsc_siletti_slurm = fs::path(test_path("data/gwas_repo/bipolar_disorder/bipolar_disorder/analysis/ldsc/pldsc/siletti/run_all.sh")),
